...
const zhTW: Messages = {
    ...
    "settings.title": "桌面設定", "settings.subtitle": "中繼資料存取與重新命名偏好", "settings.metadataProvider": "中繼資料來源", "settings.thetvdbApiKey": "TheTVDB API 金鑰", "settings.thetvdbPin": "TheTVDB PIN（選填）", "settings.tmdbApiKey": "TMDB API 金鑰", "settings.newThetvdbKey": "貼上 TheTVDB v4 API 金鑰", "settings.newThetvdbPin": "subscriber-supported 金鑰需要 PIN", "settings.newTmdbKey": "貼上 TMDB v3 API 金鑰", "settings.savedPin": "PIN 已儲存 - 輸入新值即可取代", "settings.environmentCredential": "由 {name} 環境變數管理。", "settings.apiKey": "TMDB API 金鑰", "settings.savedKey": "金鑰已儲存 - 輸入新值即可取代", "settings.newKey": "貼上 TMDB v3 API 金鑰", "settings.environmentKey": "由 TMDB_API_KEY 環境變數管理。", "settings.uiLanguage": "介面語言", "settings.metadataLanguage": "中繼資料語言", "settings.conflict": "目標檔案已存在時", "settings.conflictSuffix": "加入數字後綴", "settings.conflictSkip": "略過檔案", "settings.conflictOverwrite": "覆寫目標", "settings.appearance": "外觀", "settings.themeSystem": "跟隨系統", "settings.themeLight": "淺色", "settings.themeDark": "深色", "settings.save": "儲存設定",
