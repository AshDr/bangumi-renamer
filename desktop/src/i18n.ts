...
const en = {
    ...
    "workflow.choose": "Choose a folder",
    "workflow.review": "Review matches",
    "workflow.apply": "Renaming complete",
    ...
    "workspace.rematch": "Rematch",
    "workspace.chooseOther": "Choose another folder",
    ...
    "table.pickMatch": "Pick another metadata match",
    "status.OK": "Ready",
    ...
    "status.error": "Error",
    "footer.connected": "{provider} connected",
    "footer.keyRequired": "{provider} key required",
    "footer.previewCount": "{count} files",
    "footer.apply": "Apply",
    "notice.apiKeyRequired": "Add a {provider} API key before scanning.",
    ...
    "busy.scanning": "Scanning files and matching {provider}...",
    "busy.matching": "Rebuilding selected matches...",
    "busy.applying": "Applying verified renames...",
    "settings.title": "Desktop settings",
    "settings.subtitle": "Metadata access and rename preferences",
    "settings.metadataProvider": "Metadata provider",
    "provider.thetvdb": "TheTVDB",
    "provider.tmdb": "TMDB",
    "settings.thetvdbApiKey": "TheTVDB API key",
    "settings.thetvdbPin": "TheTVDB PIN (optional)",
    "settings.tmdbApiKey": "TMDB API key",
    "settings.newThetvdbKey": "Paste a TheTVDB v4 API key",
    "settings.newThetvdbPin": "Required for subscriber-supported keys",
    "settings.newTmdbKey": "Paste a TMDB v3 API key",
    "settings.savedPin": "PIN is saved - enter a new value to replace it",
    "settings.environmentCredential": "Managed by the {name} environment variable.",
    ...
    "settings.testConnection": "Test {provider} connection",
    "settings.connectionSuccess": "{provider} connection succeeded.",
    "locale.zh-CN": "简体中文",
    "locale.zh-TW": "繁體中文",
    "locale.en-US": "English",
    "locale.ja-JP": "日本語",
    "candidate.title": "Choose a {provider} match",
    "candidate.searching": "Searching {provider}...",
...
const zhCN: Messages = {
    ...
    "footer.connected": "{provider} 已连接", "footer.keyRequired": "需要 {provider} 密钥", "footer.previewCount": "{count} 个文件", "footer.apply": "应用",
    "notice.apiKeyRequired": "请先添加 {provider} API 密钥再扫描。", "notice.previewReady": "预览已就绪 - 已检查 {count} 个文件。", "notice.noFiles": "此文件夹中没有支持的视频或字幕文件。", "notice.renamed": "已重命名 {count} 个文件。历史记录已保存至 {path}", "notice.noRename": "没有需要重命名的文件。", "notice.matched": "已将 {count} 个文件匹配到 {name}。", "notice.settingsSaved": "设置已保存。",
    "busy.scanning": "正在扫描文件并匹配 {provider}...", "busy.matching": "正在重新生成所选匹配...", "busy.applying": "正在应用已确认的重命名...",
    "settings.title": "桌面设置", "settings.subtitle": "元数据访问与重命名偏好", "settings.metadataProvider": "元数据源", "provider.thetvdb": "TheTVDB", "provider.tmdb": "TMDB", "settings.thetvdbApiKey": "TheTVDB API 密钥", "settings.thetvdbPin": "TheTVDB PIN（可选）", "settings.tmdbApiKey": "TMDB API 密钥", "settings.newThetvdbKey": "粘贴 TheTVDB v4 API 密钥", "settings.newThetvdbPin": "subscriber-supported 密钥需要 PIN", "settings.newTmdbKey": "粘贴 TMDB v3 API 密钥", "settings.savedPin": "PIN 已保存 - 输入新值即可替换", "settings.environmentCredential": "由 {name} 环境变量管理。", "settings.apiKey": "TMDB API 密钥", "settings.savedKey": "密钥已保存 - 输入新值即可替换", "settings.newKey": "粘贴 TMDB v3 API 密钥", "settings.environmentKey": "由 TMDB_API_KEY 环境变量管理。", "settings.uiLanguage": "界面语言", "settings.metadataLanguage": "元数据语言", "settings.conflict": "目标文件已存在时", "settings.conflictSuffix": "添加数字后缀", "settings.conflictSkip": "跳过文件", "settings.conflictOverwrite": "覆盖目标", "settings.appearance": "外观", "settings.themeSystem": "跟随系统", "settings.themeLight": "浅色", "settings.themeDark": "深色", "settings.save": "保存设置", "settings.testConnection": "测试 {provider} 连接", "settings.connectionSuccess": "{provider} 连接成功。",
    "locale.zh-CN": "简体中文", "locale.zh-TW": "繁體中文", "locale.en-US": "English", "locale.ja-JP": "日本語",
    "candidate.title": "选择 {provider} 匹配", "candidate.searching": "正在搜索 {provider}...", "candidate.empty": "未找到候选项。", "candidate.noOriginalTitle": "无原始标题", "candidate.noOverview": "暂无简介。",
...
const zhTW: Messages = {
    ...
    "footer.connected": "{provider} 已連線", "footer.keyRequired": "需要 {provider} 金鑰", "footer.previewCount": "{count} 個檔案", "footer.apply": "套用",
    "notice.apiKeyRequired": "請先新增 {provider} API 金鑰再掃描。", "notice.previewReady": "預覽已就緒 - 已檢查 {count} 個檔案。", "notice.noFiles": "此資料夾中沒有支援的影片或字幕檔案。", "notice.renamed": "已重新命名 {count} 個檔案。歷史記錄已儲存至 {path}", "notice.noRename": "沒有需要重新命名的檔案。", "notice.matched": "已將 {count} 個檔案配對到 {name}。", "notice.settingsSaved": "設定已儲存。",
    "busy.scanning": "正在掃描檔案並配對 {provider}...", "busy.matching": "正在重新產生所選配對...", "busy.applying": "正在套用已確認的重新命名...",
    "settings.title": "桌面設定", "settings.subtitle": "中繼資料存取與重新命名偏好", "settings.metadataProvider": "中繼資料來源", "settings.thetvdbApiKey": "TheTVDB API 金鑰", "settings.thetvdbPin": "TheTVDB PIN（選填）", "settings.tmdbApiKey": "TMDB API 金鑰", "settings.newThetvdbKey": "貼上 TheTVDB v4 API 金鑰", "settings.newThetvdbPin": "subscriber-supported 金鑰需要 PIN", "settings.newTmdbKey": "貼上 TMDB v3 API 金鑰", "settings.savedPin": "PIN 已儲存 - 輸入新值即可取代", "settings.environmentCredential": "由 {name} 環境變數管理。", "settings.apiKey": "TMDB API 金鑰", "settings.savedKey": "金鑰已儲存 - 輸入新值即可取代", "settings.newKey": "貼上 TMDB v3 API 金鑰", "settings.environmentKey": "由 TMDB_API_KEY 環境變數管理。", "settings.uiLanguage": "介面語言", "settings.metadataLanguage": "中繼資料語言", "settings.conflict": "目標檔案已存在時", "settings.conflictSuffix": "加入數字後綴", "settings.conflictSkip": "略過檔案", "settings.conflictOverwrite": "覆寫目標", "settings.appearance": "外觀", "settings.themeSystem": "跟隨系統", "settings.themeLight": "淺色", "settings.themeDark": "深色", "settings.save": "儲存設定", "settings.testConnection": "測試 {provider} 連線", "settings.connectionSuccess": "{provider} 連線成功。",
    "candidate.title": "選擇 {provider} 配對", "candidate.searching": "正在搜尋 {provider}...", "candidate.empty": "找不到候選項目。", "candidate.noOriginalTitle": "無原始標題", "candidate.noOverview": "暫無簡介。",
...
const jaJP: Messages = {
    ...
    "footer.connected": "{provider} 接続済み", "footer.keyRequired": "{provider} キーが必要です", "footer.previewCount": "{count} ファイル", "footer.apply": "適用",
    "notice.apiKeyRequired": "スキャンする前に {provider} API キーを追加してください。", "notice.previewReady": "プレビュー準備完了 - {count} ファイルを確認しました。", "notice.noFiles": "このフォルダーに対応する動画または字幕ファイルはありません。", "notice.renamed": "{count} ファイルの名前を変更しました。履歴: {path}", "notice.noRename": "名前を変更するファイルはありません。", "notice.matched": "{count} ファイルを {name} に一致させました。", "notice.settingsSaved": "設定を保存しました。",
    "busy.scanning": "ファイルをスキャンし {provider} と照合中...", "busy.matching": "選択した一致を再構築中...", "busy.applying": "確認済みの変更を適用中...",
    "settings.title": "デスクトップ設定", "settings.subtitle": "メタデータアクセスとリネーム設定", "settings.metadataProvider": "メタデータプロバイダー", "settings.thetvdbApiKey": "TheTVDB API キー", "settings.thetvdbPin": "TheTVDB PIN（任意）", "settings.tmdbApiKey": "TMDB API キー", "settings.newThetvdbKey": "TheTVDB v4 API キーを貼り付け", "settings.newThetvdbPin": "subscriber-supported キーには PIN が必要です", "settings.newTmdbKey": "TMDB v3 API キーを貼り付け", "settings.savedPin": "PIN は保存済みです - 新しい値を入力して置換", "settings.environmentCredential": "{name} 環境変数で管理されています。", "settings.apiKey": "TMDB API キー", "settings.savedKey": "キーは保存済みです - 新しい値を入力して置換", "settings.newKey": "TMDB v3 API キーを貼り付け", "settings.environmentKey": "TMDB_API_KEY 環境変数で管理されています。", "settings.uiLanguage": "表示言語", "settings.metadataLanguage": "メタデータ言語", "settings.conflict": "変更先が存在する場合", "settings.conflictSuffix": "数字の接尾辞を追加", "settings.conflictSkip": "ファイルをスキップ", "settings.conflictOverwrite": "変更先を上書き", "settings.appearance": "外観", "settings.themeSystem": "システムに合わせる", "settings.themeLight": "ライト", "settings.themeDark": "ダーク", "settings.save": "設定を保存", "settings.testConnection": "{provider} 接続をテスト", "settings.connectionSuccess": "{provider} 接続に成功しました。",
    "locale.zh-CN": "简体中文", "locale.zh-TW": "繁體中文", "locale.en-US": "English", "locale.ja-JP": "日本語",
    "candidate.title": "{provider} の一致を選択", "candidate.searching": "{provider} を検索中...", "candidate.empty": "候補が見つかりません。", "candidate.noOriginalTitle": "原題なし", "candidate.noOverview": "概要はありません。",
