...
const en = {
    ...
    "sidebar.eyebrow": "RENAME STUDIO",
    "sidebar.heading": "Clean episode names, before you commit.",
    "sidebar.description": "Scan, inspect TMDB matches, then apply only the rows you approve.",
    "workflow.label": "Workflow",
    "workflow.choose": "Choose folder",
    "workflow.review": "Review matches",
    "workflow.apply": "Apply safely",
    "safety.title": "Preview first",
    "safety.description": "Nothing is renamed until you explicitly apply the plan.",
    "workspace.eyebrow": "CURRENT WORKSPACE",
    ...
    "footer.previewCount": "{count} files in preview",
    "footer.apply": "Apply {count} renames",
    "footer.applyOne": "Apply 1 rename",
    "notice.apiKeyRequired": "Add a TMDB API key before scanning.",
    "notice.previewReady": "Preview ready - {count} files inspected.",
    "notice.noFiles": "No supported video files were found in this folder.",
...
const zhCN: Messages = {
    ...
    "sidebar.eyebrow": "重命名工作台", "sidebar.heading": "确认无误，再整理剧集名称。", "sidebar.description": "扫描文件、检查 TMDB 匹配，只应用你认可的重命名。",
    "workflow.label": "工作流程", "workflow.choose": "选择文件夹", "workflow.review": "检查匹配", "workflow.apply": "安全应用",
    "safety.title": "先预览", "safety.description": "只有明确应用方案后才会重命名文件。",
    "workspace.eyebrow": "当前工作区", "workspace.select": "选择媒体文件夹", "workspace.hint": "将文件夹拖到此处，或使用选择器。", "workspace.rescan": "重新扫描", "workspace.choose": "选择文件夹",
    "drop.title": "让媒体库井然有序", "drop.description": "将动漫或电视剧文件夹拖到窗口任意位置", "drop.formats": "MKV、MP4、AVI、MOV 和 M4V",
    "summary.total": "文件总数", "summary.ready": "已就绪", "summary.review": "需要检查", "summary.rename": "将重命名",
    "table.empty": "未找到视频文件", "table.emptyHint": "请尝试其他文件夹。", "table.source": "源文件", "table.planned": "计划名称", "table.match": "匹配", "table.status": "状态", "table.unparsed": "无法解析", "table.confidence": "置信度 {value}%", "table.unmatched": "未匹配", "table.pickMatch": "选择其他 TMDB 匹配",
    "status.OK": "就绪", "status.unparsed": "无法解析", "status.no match": "无匹配", "status.no season": "无季度", "status.conflict": "冲突", "status.error": "错误",
    "footer.connected": "TMDB 已连接", "footer.keyRequired": "需要 TMDB 密钥", "footer.previewCount": "预览中有 {count} 个文件", "footer.apply": "应用 {count} 项重命名", "footer.applyOne": "应用 1 项重命名",
    "notice.apiKeyRequired": "请先添加 TMDB API 密钥再扫描。", "notice.previewReady": "预览已就绪 - 已检查 {count} 个文件。", "notice.noFiles": "此文件夹中没有支持的视频文件。", "notice.renamed": "已重命名 {count} 个文件。历史记录已保存至 {path}", "notice.noRename": "没有需要重命名的文件。", "notice.matched": "已将 {count} 个文件匹配到 {name}。", "notice.settingsSaved": "设置已保存。",
...
const zhTW: Messages = {
    ...
    "sidebar.eyebrow": "重新命名工作台", "sidebar.heading": "確認無誤，再整理劇集名稱。", "sidebar.description": "掃描檔案、檢查 TMDB 配對，只套用你認可的重新命名。",
    "workflow.label": "工作流程", "workflow.choose": "選擇資料夾", "workflow.review": "檢查配對", "workflow.apply": "安全套用",
    "safety.title": "先預覽", "safety.description": "只有明確套用方案後才會重新命名檔案。",
    "workspace.eyebrow": "目前工作區", "workspace.select": "選擇媒體資料夾", "workspace.hint": "將資料夾拖到此處，或使用選擇器。", "workspace.rescan": "重新掃描", "workspace.choose": "選擇資料夾",
    "drop.title": "讓媒體庫井然有序", "drop.description": "將動漫或電視劇資料夾拖到視窗任意位置", "drop.formats": "MKV、MP4、AVI、MOV 和 M4V",
    "summary.total": "檔案總數", "summary.ready": "已就緒", "summary.review": "需要檢查", "summary.rename": "將重新命名",
    "table.empty": "找不到影片檔案", "table.emptyHint": "請嘗試其他資料夾。", "table.source": "來源檔案", "table.planned": "計畫名稱", "table.match": "配對", "table.status": "狀態", "table.unparsed": "無法解析", "table.confidence": "信心度 {value}%", "table.unmatched": "未配對", "table.pickMatch": "選擇其他 TMDB 配對",
    "status.OK": "就緒", "status.unparsed": "無法解析", "status.no match": "無配對", "status.no season": "無季度", "status.conflict": "衝突", "status.error": "錯誤",
    "footer.connected": "TMDB 已連線", "footer.keyRequired": "需要 TMDB 金鑰", "footer.previewCount": "預覽中有 {count} 個檔案", "footer.apply": "套用 {count} 項重新命名", "footer.applyOne": "套用 1 項重新命名",
    "notice.apiKeyRequired": "請先新增 TMDB API 金鑰再掃描。", "notice.previewReady": "預覽已就緒 - 已檢查 {count} 個檔案。", "notice.noFiles": "此資料夾中沒有支援的影片檔案。", "notice.renamed": "已重新命名 {count} 個檔案。歷史記錄已儲存至 {path}", "notice.noRename": "沒有需要重新命名的檔案。", "notice.matched": "已將 {count} 個檔案配對到 {name}。", "notice.settingsSaved": "設定已儲存。",
...
const jaJP: Messages = {
    ...
    "sidebar.eyebrow": "リネームスタジオ", "sidebar.heading": "確認してから、エピソード名を整理。", "sidebar.description": "スキャンして TMDB の一致を確認し、承認した項目だけを適用します。",
    "workflow.label": "ワークフロー", "workflow.choose": "フォルダーを選択", "workflow.review": "一致を確認", "workflow.apply": "安全に適用",
    "safety.title": "まずプレビュー", "safety.description": "プランを明示的に適用するまでファイル名は変更されません。",
    "workspace.eyebrow": "現在のワークスペース", "workspace.select": "メディアフォルダーを選択", "workspace.hint": "ここにフォルダーをドロップするか、選択画面を使用します。", "workspace.rescan": "再スキャン", "workspace.choose": "フォルダーを選択",
    "drop.title": "ライブラリをきれいに整理", "drop.description": "アニメまたはテレビ番組のフォルダーをウィンドウ内にドロップ", "drop.formats": "MKV、MP4、AVI、MOV、M4V",
    "summary.total": "合計ファイル", "summary.ready": "準備完了", "summary.review": "要確認", "summary.rename": "変更予定",
    "table.empty": "動画ファイルが見つかりません", "table.emptyHint": "別のフォルダーをお試しください。", "table.source": "元のファイル", "table.planned": "変更後の名前", "table.match": "一致", "table.status": "状態", "table.unparsed": "解析できません", "table.confidence": "信頼度 {value}%", "table.unmatched": "未一致", "table.pickMatch": "別の TMDB 一致を選択",
    "status.OK": "準備完了", "status.unparsed": "解析不可", "status.no match": "一致なし", "status.no season": "シーズンなし", "status.conflict": "競合", "status.error": "エラー",
    "footer.connected": "TMDB 接続済み", "footer.keyRequired": "TMDB キーが必要です", "footer.previewCount": "プレビューに {count} ファイル", "footer.apply": "{count} 件の変更を適用", "footer.applyOne": "1 件の変更を適用",
    "notice.apiKeyRequired": "スキャンする前に TMDB API キーを追加してください。", "notice.previewReady": "プレビュー準備完了 - {count} ファイルを確認しました。", "notice.noFiles": "このフォルダーに対応動画ファイルはありません。", "notice.renamed": "{count} ファイルの名前を変更しました。履歴: {path}", "notice.noRename": "名前を変更するファイルはありません。", "notice.matched": "{count} ファイルを {name} に一致させました。", "notice.settingsSaved": "設定を保存しました。",
